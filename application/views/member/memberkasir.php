	...
	<div class="row">
		...
		<div class="col-7">
			<button type="button" class="btn btn-primary mt-4" data-toggle="modal" data-target="#add"> <i
					class="fas fa-user-plus"></i></butttom>
		</div>
		<div class="col-3">
              ...
              ?>
						<tr>
							...
							<td style="width:50px">
								<center>
									<div class="col-12">
										<a href="<?php echo site_url('kasir/edit_data_member/'.$datas->id_member); ?>"><button
												class=" btn btn-success btn-sm edit_data" style="width: 100%;"><i
									...
									<div class="col-md-8" style="background:linear-gradient(to right,white,white);">
										<div class="card-body" style="margin: 2%;">
											<div class="row">
												...
												<form action="<?php echo site_url('kasir/simpan_member_kasir');?>" method="post"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="<?php echo site_url('kasir/delete_data/'.$datas->id_member); ?>"> <button type="button"
