                ...
                <div class="card" style="max-width: 100%; margin-top: 1%;margin-bottom: 2%;border-color: dodgerblue;">
                    <div class="row no-gutters">
                      ...
                      <div class="col-md-8" style="background:linear-gradient(to right,white,dodgerblue);">
                        ...
                        <form action="<?php echo site_url('sistem/aksi_edit_paket');?>" method="post" enctype="multipart/form-data" >
                        ...
                        foreach($data_edit_paket as $e):?>
                         <input type="hidden" name="id_paket" value="<?php echo $e->id_paket;?>">
                          ...
                          <center>
                          <h4 class="card-title " style="color: white;">Edit Paket</h4></div>
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="input-group mb-2">
                              ...
                              <input type="number" value="<?php echo $e->id_outlet;?>" readonly class="form-control" id="inlineFormInputGroup" name="idout" placeholder="">
                            </div>
                          </div>
                          <div class="col-sm-12">
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="input-group mb-2">
                              ...
                              <input type="text" value="<?php echo $e->harga;?>" class="form-control" id="inlineFormInputGroup" name="harga" placeholder="">
                            </div>
                          </div>
                          <div class="col-sm-12">
                            ...
                            <div class="input-group mb-2">
                              ...
                              <input type="text" value="<?php echo $e->nama_paket;?>" class="form-control" id="inlineFormInputGroup" name="nama_paket" placeholder="">
                            </div>
                          </div>
                         ...
                         <a class="btn btn-danger" href="<?php echo site_url('sistem/index/paket'); ?>">Cancel</a> </center>
                         </div>
                        </div>
                      </div>
                    </div>
