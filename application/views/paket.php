		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="<?php echo site_url('sistem/delete_paket/'.$datas->id_paket); ?>"> <button type="button"
										...
										<div class="card-body" style="margin: 2%;">
											...
											<div class="col-sm-6">
												...
												<div class="input-group mb-2">
													...
													<input type="text" class="form-control" id="inlineFormInputGroup" name="diskon"
														placeholder="">
												</div>
											</div>
											<div class="col-sm-12">
												...
												<div class="input-group mb-2">
													...
													<input type="text" class="form-control" id="inlineFormInputGroup" name="nama_paket"
														placeholder="">
												</div>
											</div>
											<!-- </div> -->
