		...
		<div class="main_body">
			...
			<div class="sidebar_menu">
				<div class="inner__sidebar_menu">
					...
					<ul>
						<li>
							<a href="<?php echo site_url('kasir/indexkasir/homekasir'); ?>">
								<span class="icon">
						...
						<li>
							<a href="<?php echo site_url('kasir/indexkasir/memberkasir'); ?>">
			...
			<div class="container">
				<div class="row">
					<div class="col-12">
						<?php
					if ($this->uri->segment(3) == "homekasir") {
						$this->load->view('home/homekasir');
						}
					?>
						<?php 
          ...
          if ($this->uri->segment(3) == "memberkasir") {
            $this->load->view('member/memberkasir');
		  ...
		  elseif ($this->uri->segment(3) == "transaksi_day") {
            ...
            $this->load->view('edit/edit_member_kasir');
