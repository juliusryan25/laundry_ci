	...
	<div class="row">
		...
		<div class="col-xl-6 col-md-6 mb-4">
			<div class="card border-left-success shadow h-100 py-2 menu_card ">
				<a href="<?php echo site_url('kasir/indexkasir/memberkasir'); ?>" style="text-decoration:none;">
					<div class="card-body">
		...
		<div class="col-xl-6 col-md-6 mb-4">
			<div class="card border-left-primary shadow h-100 py-2 menu_card">
				<a href="<?php echo site_url('kasir/indexkasir/transaksi_day'); ?>" style="text-decoration:none;">
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<center>
