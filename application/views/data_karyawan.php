...
<div class="col-md-2">  
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add" > <i class="far fa-address-card"></i> &nbsp+</butttom>
            </div>
            ...
            <div class="table-responsive mb-4">
              ...
              ?>
               <tr>
                  ...
                  <td>
                  <div class="col-12">
                   <a href="<?php echo site_url('sistem/edit_data_user/'.$datas->id_user); ?>"> <button  class=" btn btn-success btn-sm edit_data" style="width: 100%;" ><i class="fas fa-edit"></i>   </button></a>
                    </div>
                ...
                <div class="card" style="max-width: 100%; margin-top: 1%;margin-bottom: 2%;border-color: DodgerBlue;">
                    <div class="row no-gutters">
                      ...
                      <div class="col-md-8" style="background:linear-gradient(to right,white,DodgerBlue);">
                        ...
                        <div class="col-sm-12">
                          <center>
                          <h4 class="card-title " style="color: white;">Employe</h4></div>
                  ...
                  <div class="modal-content">
                   ...
                   <center>  <img src="<?php echo base_url(); ?>assets/image/seru.png" style="width:150px" class="card-img" alt="..."></center><br>
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="<?php echo site_url('sistem/delete_data_user/'.$datas->id_user); ?>"> <button type="button" class="btn btn-primary">Yes</button></a>
                    </div>
                  </div>
                </div>
              </div>
