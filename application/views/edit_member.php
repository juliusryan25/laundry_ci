                ...
                <div class="card" style="max-width: 100%; margin-top: 1%;margin-bottom: 2%;border-color:DodgerBlue;">
                    <div class="row no-gutters">
                      ...
                      <div class="col-md-8" style="background:linear-gradient(to right,white,DodgerBlue);">
                        ...
                        <div class="col-sm-12">
                          <center>
                          <h4 class="card-title " style="color: white;">Edit Member</h4></div>


                          <form action="<?php echo site_url('sistem/aksi_edit');?>" method="post" enctype="multipart/form-data" >
                    ...
                    <?php
                        ...
                        <input type="hidden" name="id" value="<?php echo $e->id_member;?>">
                         ...
                         <a href="<?php echo site_url('sistem/index/member1'); ?>"><button type="submit" name="save"  class="btn btn-danger"> Cancel </button></a>&nbsp&nbsp&nbsp
                         </center>
                        </div>
                      </div>
                    </div>
