...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2020 at 07:34 AM
...
(6, 'Julius', 'Depok', '123456789'),
(7, 'Hadi', 'DEPOK', '123456789876');
...
CREATE TABLE `tb_transaksi` (
  ...
  `bayar` enum('dibayar','belum_dibayar') NOT NULL,
...
INSERT INTO `tb_transaksi` (`id_transaksi`, `id_outlet`, `kode_invoice`, `id_member`, `tgl`, `batas_waktu`, `tgl_bayar`, `biaya_tambahan`, `diskon`, `pajak`, `status`, `bayar`, `id_user`) VALUES
(1, 6, '1', 1, '2020-08-06 08:00:00', '2020-08-07 08:00:00', '2020-08-07 06:00:00', 0, 0, 0, 'diambil', 'dibayar', 1);
...
(1, 'Julius', 'Panjul', 'panjul123', 6, 'admin');
